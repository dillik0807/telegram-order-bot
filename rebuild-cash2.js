...
const startIdx = c.indexOf('async function buildCashMessage');
const endIdx = c.indexOf("bot.on('text'");
...
// Go back to find the comment line before the function
const commentMarker = '// \u0412\u0441\u043F\u043E\u043C\u043E\u0433\u0430\u0442\u0435\u043B\u044C\u043D\u0430\u044F \u0444\u0443\u043D\u043A\u0446\u0438\u044F';
const commentIdx = c.lastIndexOf(commentMarker, startIdx);
const actualStart = commentIdx !== -1 ? commentIdx : startIdx;

console.log('Found at:', actualStart, '-', endIdx);
...
const newContent = c.slice(0, actualStart) + newFunc + c.slice(endIdx);
